...
//   {
//     // NEW: explicit owner (source of truth for permissions)
//     ownerId: { type: Types.ObjectId, ref: 'User', required: true, index: true },

//     // optional parent course (standalone quizzes allowed)
//     courseId: { type: Types.ObjectId, ref: 'Course', index: true },

//     // NEW: public slug for nice URLs
...
//     // delivery rules
//     timeLimitSec: { type: Number, default: 0, min: 0 },      // 0 = no limit
//     attemptsAllowed: { type: Number, default: 1, min: 1 },
//     passPercent: { type: Number, default: 70, min: 0, max: 100 },
//     isPublished: { type: Boolean, default: false, index: true },
//     visibility: {
//       type: String,
//       enum: ['enrolled', 'public'], // 'enrolled' = require login for standalone MVP
//       default: 'enrolled',
//       index: true
//     },

//     // NEW: delivery QoL flags (safe defaults)
//     shuffleQuestions: { type: Boolean, default: false },
//     shuffleOptions: { type: Boolean, default: false },

//     // rollups (denormalized)
